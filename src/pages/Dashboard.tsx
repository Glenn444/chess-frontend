    ...
    <div className="fade-in" style={{ display: 'flex', minHeight: '100vh' }}>
      ...
      <main style={{ flex: 1, padding: pad, overflow: 'auto' }}>
        ...
        <div style={{
          ...
          <div style={{ background: 'var(--color-bg-elev)', border: '1px solid var(--color-border)', borderRadius: 16, padding: 20 }}>
            <div style={{ fontSize: 12, color: 'var(--color-text-muted)', textTransform: 'uppercase', letterSpacing: 0.6, fontWeight: 600 }}>Active games</div>
            <div className="font-display" style={{ fontSize: 34, fontWeight: 500, marginTop: 4, letterSpacing: -0.5, color: 'var(--color-amber)' }}>{activeGames.length}</div>
          </div>
          <div style={{ background: 'var(--color-bg-elev)', border: '1px solid var(--color-border)', borderRadius: 16, padding: 20 }}>
            <div style={{ fontSize: 12, color: 'var(--color-text-muted)', textTransform: 'uppercase', letterSpacing: 0.6, fontWeight: 600 }}>Waiting for opponent</div>
            <div className="font-display" style={{ fontSize: 34, fontWeight: 500, marginTop: 4, letterSpacing: -0.5, color: 'var(--color-amber-light)' }}>{waitingGames.length}</div>
          </div>
          <div style={{ background: 'var(--color-bg-elev)', border: '1px solid var(--color-border)', borderRadius: 16, padding: 20 }}>
            <div style={{ fontSize: 12, color: 'var(--color-text-muted)', textTransform: 'uppercase', letterSpacing: 0.6, fontWeight: 600 }}>Total games</div>
            <div className="font-display" style={{ fontSize: 34, fontWeight: 500, marginTop: 4, letterSpacing: -0.5 }}>{myGames.length}</div>
          </div>
        </div>
